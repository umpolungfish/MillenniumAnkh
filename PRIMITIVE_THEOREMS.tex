...
$P$ at $\Phi_c$ & Character of $\mu$: explicit symmetry ($P_\text{pm\_sym}$) = \textbf{special} Frobenius; implicit symmetry ($P_\text{neutral}$) = \textbf{full but non-special} Frobenius \\
