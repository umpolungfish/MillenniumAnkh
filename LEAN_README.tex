...
The YM barrier ($G_\text{LOCAL}$, no quantum lift) corresponds to the G-scope analysis in {[}ONTICS:\pilcrow{}XVII{]}: the quantum-gravity tensor product fails at $G_\text{LOCAL}$ because the carrier type (path integral measure) cannot be constructed in 4D.
