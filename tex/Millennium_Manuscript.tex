...
\begin{enumerate}
    ...
    \item \textbf{Chirality ($H$):} The Markov order --- memoryless ($H_0$), weak temporal asymmetry ($H_1$), strong temporal asymmetry ($H_2$), or inexhaustible depth ($H_{\infty}$). $H_{\infty}$ tends to co-occur with $K_\text{trap}$ but this is a structural tendency, not a hard axiom.
